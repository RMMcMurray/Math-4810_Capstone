...
# Plot 1: Studentized Residual vs. Fitted Values
ax1.scatter(model.fittedvalues, student_resid, alpha=0.7, edgecolors='k')
ax1.axhline(y=0, color='red', linestyle='--')
ax1.axhline(y=3, color='grey', linestyle=':')
ax1.axhline(y=-3, color='grey', linestyle=':')
ax1.set_xlabel('Fitted Values')
ax1.set_ylabel('Studentized Residuals')
ax1.set_title('Studentized Residual Plot')

# Plot 2: Normal Q-Q Plot of Studentized Residuals
sm.qqplot(student_resid, line='45', ax=ax2)
