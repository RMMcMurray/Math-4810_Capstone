...
merged_df = pd.merge(
    residential_export, 
    parcel_export, 
    left_on='Parcel Number', 
    right_on='ParcelId', 
    how='right')
merged_df = merged_df.merge(land_export, left_on='ParcelId', right_on='Parcel Number', how='left')
merged_df = merged_df.merge(multi_fam_export, 
                            left_on='ParcelId', right_on='Parcel Number', 
                            how='left', suffixes=('', '_multi'))
